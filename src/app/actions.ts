    ...
    try {
        ...
        for (const pair of pairs) {
            ...
            try {
                ...
                // Only update if we have valid RSI data for 1h
                if (rsi1h !== null) {
                    const rsiDataToSave = {
                    ...
                    console.warn(`Skipping RSI update for ${tokenContractAddress} due to insufficient 1h data (RSI is null).`);
                }
